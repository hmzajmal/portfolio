...
export function ThemeToggle({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`inline-flex h-10 w-10 items-center justify-center rounded-none border border-[var(--color-line-strong)] bg-[var(--color-canvas)] text-ink outline-none transition-colors hover:bg-[var(--color-canvas-warm)] focus-visible:ring-2 focus-visible:ring-[#5ECCDD] focus-visible:ring-offset-2 ${className}`}
    >
